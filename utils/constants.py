...
# Метка «взять случайную»: настоящий файл выбирается для каждого видео
# отдельно, уже во время обработки. Если выбрать один раз в окне, вся партия
# получит одну и ту же залипалку — а нужно наоборот.
RANDOM_FILLER = "__random__"
